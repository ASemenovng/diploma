...
plot_portfolio_returns_with_moving_average(portfolio_1_avg, "акций, показатель E/P которых ниже медианы")
plot_portfolio_returns_with_moving_average(portfolio_2_avg, "акций, показатель E/P которых выше медианы")
